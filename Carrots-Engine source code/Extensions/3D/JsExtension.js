...
module.exports = {
  createExtension: function (_, gd) {
    ...
    const CSG3DObject = new gd.ObjectJsImplementation();
    CSG3DObject.updateProperty = function (propertyName, newValue) {
      const objectContent = this.content;
      ...
      if (
        propertyName === 'radius' ||
        propertyName === 'radialSegments' ||
        propertyName === 'heightSegments' ||
        propertyName === 'tube' ||
        propertyName === 'tubularSegments' ||
        propertyName === 'arc' ||
        propertyName === 'capSegments' ||
        propertyName === 'thetaStart' ||
        propertyName === 'thetaLength' ||
        propertyName === 'phiStart' ||
        propertyName === 'phiLength' ||
        propertyName === 'wallThickness' ||
        propertyName === 'collisionLayer' ||
        propertyName === 'collisionMask' ||
        propertyName === 'collisionPriority' ||
        propertyName === 'smoothingAngle'
      ) {
        objectContent[propertyName] = parseFloat(newValue);
        return true;
      }
      ...
      if (
        propertyName === 'openEnded' ||
        propertyName === 'roomMode' ||
        propertyName === 'facesInward' ||
        propertyName === 'enableTextureTransparency' ||
        propertyName === 'resourceRepeat' ||
        propertyName === 'isCastingShadow' ||
        propertyName === 'isReceivingShadow' ||
        propertyName === 'generateCollision' ||
        propertyName === 'calculateTangents' ||
        propertyName === 'autoSmooth' ||
        propertyName === 'mergeVertices' ||
        propertyName === 'bakeOnStart'
      ) {
        objectContent[propertyName] = newValue === '1' || newValue === 'true';
        return true;
      }
      ...
      if (propertyName === 'shape') {
        const validChoices = ["Box", "Sphere", "Cylinder", "Cone", "Torus", "Capsule"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.shape = newValue;
        return true;
      }

      if (propertyName === 'csgRole') {
        const validChoices = ["Solid", "Room", "Cutter"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.csgRole = newValue;
        return true;
      }
      ...
      if (propertyName === 'csgOperation') {
        const validChoices = ["Union", "Subtract", "Intersect"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.csgOperation = newValue;
        return true;
      }
      ...
      if (propertyName === 'csgMode') {
        const validChoices = ["Single", "Combined"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.csgMode = newValue;
        return true;
      }

      if (propertyName === 'faceOrientation') {
        const validChoices = ["Outward", "Inward", "DoubleSided"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.faceOrientation = newValue;
        return true;
      }

      if (propertyName === 'collisionShape') {
        const validChoices = ["Box", "Mesh", "ConvexHull"];
        if (validChoices.indexOf(newValue) === -1) return false;
        objectContent.collisionShape = newValue;
        return true;
      }
      ...
      if (propertyName === 'tint') {
        objectContent.tint = newValue;
        return true;
      }
    ...
    CSG3DObject.getProperties = function () {
      const objectProperties = new gd.MapStringPropertyDescriptor();
      const objectContent = this.content;
      ...
      objectProperties
        .getOrCreate('radius')
        .setValue((objectContent.radius !== undefined ? objectContent.radius : 1).toString())
        .setType('number')
        .setLabel(_('Radius'))
        .setGroup(_('Shape'))
        .setAdvanced(true);
      ...
      objectProperties
        .getOrCreate('radialSegments')
        .setValue((objectContent.radialSegments !== undefined ? objectContent.radialSegments : 32).toString())
        .setType('number')
        .setLabel(_('Radial segments'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('heightSegments')
        .setValue((objectContent.heightSegments !== undefined ? objectContent.heightSegments : 1).toString())
        .setType('number')
        .setLabel(_('Height segments'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('tube')
        .setValue((objectContent.tube !== undefined ? objectContent.tube : 0.4).toString())
        .setType('number')
        .setLabel(_('Tube radius'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('tubularSegments')
        .setValue((objectContent.tubularSegments !== undefined ? objectContent.tubularSegments : 8).toString())
        .setType('number')
        .setLabel(_('Tubular segments'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('arc')
        .setValue((objectContent.arc !== undefined ? objectContent.arc : (Math.PI * 2)).toString())
        .setType('number')
        .setLabel(_('Arc'))
        .setGroup(_('Shape'))
        .setAdvanced(true);
      ...
      objectProperties
        .getOrCreate('capSegments')
        .setValue((objectContent.capSegments !== undefined ? objectContent.capSegments : 4).toString())
        .setType('number')
        .setLabel(_('Cap segments'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('thetaStart')
        .setValue((objectContent.thetaStart !== undefined ? objectContent.thetaStart : 0).toString())
        .setType('number')
        .setLabel(_('Theta start'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('thetaLength')
        .setValue((objectContent.thetaLength !== undefined ? objectContent.thetaLength : (Math.PI * 2)).toString())
        .setType('number')
        .setLabel(_('Theta length'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('phiStart')
        .setValue((objectContent.phiStart !== undefined ? objectContent.phiStart : 0).toString())
        .setType('number')
        .setLabel(_('Phi start'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('phiLength')
        .setValue((objectContent.phiLength !== undefined ? objectContent.phiLength : Math.PI).toString())
        .setType('number')
        .setLabel(_('Phi length'))
        .setGroup(_('Shape'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('wallThickness')
        .setValue((objectContent.wallThickness !== undefined ? objectContent.wallThickness : 8).toString())
        .setType('number')
        .setLabel(_('Wall thickness'))
        .setGroup(_('Face orientation (room)'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('collisionLayer')
        .setValue((objectContent.collisionLayer !== undefined ? objectContent.collisionLayer : 0).toString())
        .setType('number')
        .setLabel(_('Collision layer'))
      ...
      objectProperties
        .getOrCreate('collisionMask')
        .setValue((objectContent.collisionMask !== undefined ? objectContent.collisionMask : 1).toString())
        .setType('number')
        .setLabel(_('Collision mask'))
        .setGroup(_('Collision'))
        .setAdvanced(true);
      ...
      objectProperties
        .getOrCreate('collisionPriority')
        .setValue((objectContent.collisionPriority !== undefined ? objectContent.collisionPriority : 0).toString())
        .setType('number')
        .setLabel(_('Collision priority'))
        .setGroup(_('Collision'))
        .setAdvanced(true);
      ...
      objectProperties
        .getOrCreate('smoothingAngle')
        .setValue((objectContent.smoothingAngle !== undefined ? objectContent.smoothingAngle : 30).toString())
        .setType('number')
        .setLabel(_('Smoothing angle'))
        .setGroup(_('Geometry optimization'))
        .setAdvanced(true);

      objectProperties
        .getOrCreate('openEnded')
        .setValue(objectContent.openEnded ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Open ended'))
        .setGroup(_('Shape'));
      ...
      objectProperties
        .getOrCreate('facesInward')
        .setValue(objectContent.facesInward ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Faces inward'))
        .setGroup(_('Face orientation (room)'));
      ...
      objectProperties
        .getOrCreate('resourceRepeat')
        .setValue(objectContent.resourceRepeat ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Repeat texture'))
        .setGroup(_('Visual'));
      ...
      objectProperties
        .getOrCreate('autoSmooth')
        .setValue(objectContent.autoSmooth ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Auto smooth'))
        .setGroup(_('Geometry optimization'));

      objectProperties
        .getOrCreate('mergeVertices')
        .setValue(objectContent.mergeVertices ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Merge vertices'))
        .setGroup(_('Geometry optimization'));

      objectProperties
        .getOrCreate('bakeOnStart')
        .setValue(objectContent.bakeOnStart ? 'true' : 'false')
        .setType('boolean')
        .setLabel(_('Bake on start'))
        .setGroup(_('Baking'));

      objectProperties
        .getOrCreate('csgRole')
        .setValue(objectContent.csgRole || 'Solid')
        .setType('choice')
        .addChoice('Solid', _('Solid'))
        .addChoice('Room', _('Room'))
        .addChoice('Cutter', _('Cutter'))
        .setLabel(_('CSG role'))
        .setGroup(_('CSG'));
      ...
      objectProperties
        .getOrCreate('csgMode')
        .setValue(objectContent.csgMode || 'Single')
        .setType('choice')
        .addChoice('Single', _('Single'))
        .addChoice('Combined', _('Combined'))
        .setLabel(_('CSG mode'))
        .setGroup(_('CSG'));

      objectProperties
        .getOrCreate('faceOrientation')
        .setValue(objectContent.faceOrientation || 'Outward')
        .setType('choice')
        .addChoice('Outward', _('Outward'))
        .addChoice('Inward', _('Inward'))
        .addChoice('DoubleSided', _('DoubleSided'))
        .setLabel(_('Face orientation'))
        .setGroup(_('Face orientation (room)'));

      objectProperties
        .getOrCreate('collisionShape')
        .setValue(objectContent.collisionShape || 'Box')
        .setType('choice')
        .addChoice('Box', _('Box'))
        .addChoice('Mesh', _('Mesh'))
        .addChoice('ConvexHull', _('ConvexHull'))
        .setLabel(_('Collision shape'))
        .setGroup(_('Collision'));

      objectProperties
        .getOrCreate('targetObjectName')
        .setValue(objectContent.targetObjectName || '')
        .setType('string')
        .setLabel(_('Target object name (for combined CSG mode)'))
        .setGroup(_('CSG'));
      ...
      objectProperties
        .getOrCreate('resourceName')
        .setValue(objectContent.resourceName || '')
        .setType('resource')
        .addExtraInfo('image')
        .setLabel(_('Texture'))
        .setGroup(_('Visual'));
    ...
    CSG3DObject.updateInitialInstanceProperty = function (
      instance,
      propertyName,
      newValue
    ) {
    ...
    CSG3DObject.getInitialInstanceProperties = function (instance) {
      const instanceProperties = new gd.MapStringPropertyDescriptor();
      return instanceProperties;
    };

    const csg3D = extension
      .addObject(
        'CSG3DObject',
        _('3D CSG shape'),
        _(
          'A 3D shape (box, sphere, cylinder, cone, torus, capsule) that supports Constructive Solid Geometry (Union, Subtract, Intersect) with other CSG3D objects, room/FlipFace mode, dynamic collision generation and geometry baking.'
        ),
        'JsPlatform/Extensions/3d_box.svg',
        CSG3DObject
      )
      ...
      .setIncludeFile('Extensions/3D/A_RuntimeObject3D.js')
      .addIncludeFile('Extensions/3D/A_RuntimeObject3DRenderer.js')
      .addIncludeFile('Extensions/3D/CSG3DRuntimeObject.js')
      .addIncludeFile('Extensions/3D/CSG3DRuntimeObjectPixiRenderer.js')
      .addIncludeFile('Extensions/3D/CSGTools.js');
    ...
    csg3D
      ...
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('Shape'))
          .setTypeExtraInfo(JSON.stringify(["Box", "Sphere", "Cylinder", "Cone", "Torus", "Capsule"]))
      )
      .setFunctionName('setShape')
      .setGetter('getShape');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'RadialSegments',
        _('Radial segments'),
        _('the number of radial segments'),
        _('the number of radial segments'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      ...
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setRadialSegments')
      .setGetter('getRadialSegments');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'HeightSegments',
        _('Height segments'),
        _('the number of height segments'),
        _('the number of height segments'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      ...
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setHeightSegments')
      .setGetter('getHeightSegments');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'TubularSegments',
        _('Tubular segments'),
        _('the number of tubular segments (for torus)'),
        _('the number of tubular segments'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setTubularSegments')
      .setGetter('getTubularSegments');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'Arc',
        _('Arc'),
        _('the arc, in radians (for cylinder/cone)'),
        _('the arc'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'CapSegments',
        _('Cap segments'),
        _('the number of cap segments (for capsule)'),
        _('the number of cap segments'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setCapSegments')
      .setGetter('getCapSegments');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'ThetaStart',
        _('Theta start'),
        _('the theta start angle, in radians (for sphere)'),
        _('the theta start angle'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setThetaStart')
      .setGetter('getThetaStart');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'ThetaLength',
        _('Theta length'),
        _('the theta length, in radians (for sphere)'),
        _('the theta length'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      ...
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setThetaLength')
      .setGetter('getThetaLength');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'PhiStart',
        _('Phi start'),
        _('the phi start angle, in radians (for sphere)'),
        _('the phi start angle'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setPhiStart')
      .setGetter('getPhiStart');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'PhiLength',
        _('Phi length'),
        _('the phi length, in radians (for sphere)'),
        _('the phi length'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      ...
      .useStandardParameters('number', gd.ParameterOptions.makeNewOptions())
      .markAsAdvanced()
      .setFunctionName('setPhiLength')
      .setGetter('getPhiLength');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'OpenEnded',
        _('Open ended'),
        _('the shape is open ended (for cylinder/cone)'),
        _('being open ended'),
        _('Shape'),
        'res/conditions/3d_box.svg'
      )
      ...
      .setFunctionName('setOpenEnded')
      .setGetter('isOpenEnded');
    ...
    csg3D
      ...
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('CSG role'))
          .setTypeExtraInfo(JSON.stringify(["Solid", "Room", "Cutter"]))
      )
      .setFunctionName('setCSGRole')
      .setGetter('getCSGRole');
    ...
    csg3D
      ...
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('CSG operation'))
          .setTypeExtraInfo(JSON.stringify(["Union", "Subtract", "Intersect"]))
      )
      .setFunctionName('setCSGOperation')
      .setGetter('getCSGOperation');
    ...
    csg3D
      ...
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('CSG mode'))
          .setTypeExtraInfo(JSON.stringify(["Single", "Combined"]))
      )
      .setFunctionName('setCSGMode')
      .setGetter('getCSGMode');

    csg3D
      .addExpressionAndConditionAndAction(
        'string',
        'TargetObjectName',
        _('Target object name'),
        _('the CSG target object name'),
        _('the CSG target object name'),
        _('CSG'),
        'res/conditions/3d_box.svg'
      )
      ...
      .setFunctionName('setTargetObjectName')
      .setGetter('getTargetObjectName');
    ...
    csg3D
      ...
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('Face orientation'))
          .setTypeExtraInfo(JSON.stringify(["Outward", "Inward", "DoubleSided"]))
      )
      .setFunctionName('setFaceOrientation')
      .setGetter('getFaceOrientation');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'FacesInward',
        _('Faces inward'),
        _('faces point inward'),
        _('having faces pointing inward'),
        _('Face orientation'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'WallThickness',
        _('Wall thickness'),
        _('the wall thickness (for room mode)'),
        _('the wall thickness'),
        _('Face orientation'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'ResourceRepeat',
        _('Repeat texture'),
        _('the texture repeats'),
        _('having texture repeat enabled'),
        _('Visual'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('boolean', gd.ParameterOptions.makeNewOptions())
      .setFunctionName('setResourceRepeat')
      .setGetter('isResourceRepeatEnabled');
    ...
    csg3D
      ...
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('string', gd.ParameterOptions.makeNewOptions())
      .setFunctionName('setResourceName')
      .setGetter('getResourceName');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        _('Generate collision'),
        _('collision generation is enabled'),
        _('having collision generation enabled'),
        _('Collision'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
    ...
    csg3D
      ...
      .useStandardParameters(
        'stringWithSelector',
        gd.ParameterOptions.makeNewOptions()
          .setDescription(_('Collision shape'))
          .setTypeExtraInfo(JSON.stringify(["Box", "Mesh", "ConvexHull"]))
      )
      .setFunctionName('setCollisionShape')
      .setGetter('getCollisionShape');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'CalculateTangents',
        _('Calculate tangents'),
        _('tangents are calculated'),
        _('having tangent calculation enabled'),
        _('Geometry optimization'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('boolean', gd.ParameterOptions.makeNewOptions())
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'SmoothingAngle',
        _('Smoothing angle'),
        _('the smoothing angle, in degrees'),
        _('the smoothing angle'),
        _('Geometry optimization'),
        'res/conditions/3d_box.svg'
      )
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'MergeVertices',
        _('Merge vertices'),
        _('vertices are merged'),
        _('having vertex merging enabled'),
        _('Geometry optimization'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('boolean', gd.ParameterOptions.makeNewOptions())
      .setFunctionName('setMergeVerticesEnabled')
      .setGetter('isMergeVerticesEnabled');
    ...
    csg3D
      .addExpressionAndConditionAndAction(
        ...
        'BakeOnStart',
        _('Bake on start'),
        _('the object bakes its geometry on start'),
        _('having baking on start enabled'),
        _('Baking'),
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .useStandardParameters('boolean', gd.ParameterOptions.makeNewOptions())
      .setFunctionName('setBakeOnStart')
      .setGetter('isBakeOnStartEnabled');


    // Special CSG combination and conversion actions:
    ...
    csg3D
      .addScopedAction(
        ...
        _('Union with object'),
        _(
          'Perform a CSG Union of this object with another CSG3D object (adds the two volumes together).'
        ),
        _('Union _PARAM0_ with _PARAM1_'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .addParameter('string', _('Other CSG3D object name'), '', false)
      .getCodeExtraInformation()
      .setFunctionName('unionWith');

    csg3D
      .addScopedAction(
        'SubtractWith',
        _('Subtract with object'),
        _(
          'Perform a CSG Subtract of this object with another CSG3D object (cuts the other volume out of this one).'
        ),
        _('Subtract _PARAM1_ from _PARAM0_'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      ...
      .addParameter('string', _('Other CSG3D object name'), '', false)
      .getCodeExtraInformation()
      .setFunctionName('subtractWith');

    csg3D
      .addScopedAction(
        'IntersectWith',
        _('Intersect with object'),
        _(
          'Perform a CSG Intersect of this object with another CSG3D object (keeps only the overlapping volume).'
        ),
        _('Intersect _PARAM0_ with _PARAM1_'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      ...
      .addParameter('string', _('Other CSG3D object name'), '', false)
      .getCodeExtraInformation()
      .setFunctionName('intersectWith');

    csg3D
      .addScopedAction(
        'ClearCSGCombination',
        _('Clear CSG combination'),
        _('Clear the CSG combination and revert the object to single mode.'),
        _('Clear the CSG combination of _PARAM0_'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .getCodeExtraInformation()
      .setFunctionName('clearCSGCombination');
    ...
    csg3D
      .addScopedAction(
        ...
        _('Convert to room'),
        _(
          'Convert this object to a room (enables inward faces and collision generation).'
        ),
        _('Convert _PARAM0_ to a room'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .getCodeExtraInformation()
      .setFunctionName('convertToRoom');

    csg3D
      .addScopedAction(
        'ConvertToCutter',
        _('Convert to cutter'),
        _('Convert this object to a cutter (enables subtractive CSG mode).'),
        _('Convert _PARAM0_ to a cutter'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .getCodeExtraInformation()
      .setFunctionName('convertToCutter');

    csg3D
      .addScopedAction(
        'ConvertToSolid',
        _('Convert to solid'),
        _('Convert this object to a plain solid (default mode).'),
        _('Convert _PARAM0_ to a solid'),
        _('CSG'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
      .addParameter('object', _('3D CSG shape'), 'CSG3DObject', false)
      .getCodeExtraInformation()
      .setFunctionName('convertToSolid');

    csg3D
      .addScopedAction(
        'FlipFaces',
        _('Flip faces'),
        _('Flip the orientation of the faces (inward/outward).'),
        _('Flip the faces of _PARAM0_'),
        _('Face orientation'),
        'res/conditions/3d_box.svg',
        'res/conditions/3d_box.svg'
      )
    ...
    csg3D
      .addScopedAction(
        'SetTint',
        _('Tint color'),
        _('Change the tint of the CSG shape.'),
        _('Change the tint of _PARAM0_ to _PARAM1_'),
        _('Visual'),
        'res/actions/color24.png',
        'res/actions/color.png'
  ...
  registerInstanceRenderers: function (objectsRenderingService) {
    ...
    class RenderedCSG3DObject2DInstance extends RenderedSimplePrimitive3DObject2DInstance {
      constructor(
        project,
        instance,
        associatedObjectConfiguration,
    ...
    class RenderedCSG3DObject3DInstance extends Rendered3DInstance {
      _defaultWidth = 100;
      _defaultHeight = 100;
      _defaultDepth = 100;
      _materialType = 'Standard';
      ...
      constructor(
        ...
        const content = object.content || {};
        this._defaultWidth = content.width || 100;
        this._defaultHeight = content.height || 100;
        this._defaultDepth = content.depth || 100;

        this._pixiObject = new PIXI.Graphics();
        this._pixiContainer.addChild(this._pixiObject);

        this._materialType = normalize3DMaterialType(content.materialType);
        this._color = content.tint || '255;255;255';
        this._shapeSignature = this._shapeKey(content);

        this._threeObject = new THREE.Mesh(
          this._buildGeometry(content),
          this._createThreeMaterial()
        );
        this._threeGroup.add(this._threeObject);
      }
      ...
      _shapeKey(content) {
        return [
          content.shape,
          content.radialSegments,
          content.heightSegments,
          content.tube,
          content.tubularSegments,
          content.arc,
          content.capSegments,
          content.thetaStart,
          content.thetaLength,
      ...
      _buildGeometry(content) {
        const shape = content.shape || 'Box';
        const radialSegments = Math.max(3, content.radialSegments || 32);
        const heightSegments = Math.max(1, content.heightSegments || 1);
        const tubularSegments = Math.max(3, content.tubularSegments || 8);
        const capSegments = Math.max(1, content.capSegments || 4);
        const arc =
          content.arc !== undefined ? content.arc : Math.PI * 2;
        const thetaStart = content.thetaStart || 0;
        const thetaLength =
          content.thetaLength !== undefined
            ? content.thetaLength
            : Math.PI * 2;
        const phiStart = content.phiStart || 0;
        const phiLength =
          content.phiLength !== undefined ? content.phiLength : Math.PI;
        const openEnded = !!content.openEnded;
        ...
        switch (shape) {
          ...
          case 'Capsule':
            return new THREE.CapsuleGeometry(
              0.5,
              1,
              Math.max(1, capSegments),
              Math.max(4, radialSegments)
            );
          case 'Box':
          default:
      ...
      updateThreeObject() {
        ...
        const nextShapeKey = this._shapeKey(content);
        if (nextShapeKey !== this._shapeSignature) {
          this._shapeSignature = nextShapeKey;
          const oldGeometry = this._threeObject.geometry;
          this._threeObject.geometry = this._buildGeometry(content);
          if (oldGeometry) oldGeometry.dispose();
        }

        const nextMaterialType = normalize3DMaterialType(content.materialType);
        const nextColor = content.tint || '255;255;255';
        if (
          nextMaterialType !== this._materialType ||
          nextColor !== this._color
        ) {
          this._materialType = nextMaterialType;
          this._color = nextColor;
          const oldMaterial = this._threeObject.material;
    ...
    objectsRenderingService.registerInstanceRenderer(
      'Scene3D::CSG3DObject',
      RenderedCSG3DObject2DInstance
    );
    objectsRenderingService.registerInstance3DRenderer(
      'Scene3D::CSG3DObject',
      RenderedCSG3DObject3DInstance
    );
