var gdjs;(function(s){const n=16,u=f=>{const r=[];for(let e=0;e<f;e++)r.push(new THREE.Vector3);return r},c=f=>{const r=[];for(let e=0;e<f;e++)r.push(0);return r},m={uniforms:{tDiffuse:{value:null},tDepth:{value:null},resolution:{value:new THREE.Vector2(1,1)},fogColor:{value:new THREE.Vector3(1,1,1)},density:{value:.012},lightScatter:{value:1},maxDistance:{value:1200},stepCount:{value:36},frameJitter:{value:0},lightCount:{value:0},lightPositions:{value:u(n)},lightColors:{value:u(n)},lightRanges:{value:c(n)},cameraProjectionMatrixInverse:{value:new THREE.Matrix4}},vertexShader:`
      varying vec2 vUv;
